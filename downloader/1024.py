...
# <a class="btn btn-primary" href="http://cosplayjav.pl/download?forPost=2950&amp;part=2" target="_blank">
cosdownload = re.compile('<a class="btn btn-primary" href="(http://cosplayjav.pl/[^"]+)" target="_blank">')

# <a href="https://mega.nz/#!TkgXyBSb!tEUNl99IoWE5zfZwJ01b9dLsmDuQJqE6SC1-dgi0Pgg" class="btn btn-primary btn-download">Download</a>
megaurl = re.compile('<a href="(https://mega.nz/[^"]+)" class="btn btn-primary btn-download">Download</a>')

# <h1 class="post-title">[MIAD-790] 有村千佳と本物素人が行く 筆おろし童貞卒業バスツアー！！</h1>
costitle = re.compile('<h1 class="post-title">(.+?)</h1>')

#<img width="560" height="420" src="http://cosplayjav.pl/wp-content/uploads/2016/06/43245GOODS_IMAGE_MAINApp.jpg" class="attachment-post-thumbnail wp-post-image" alt="43245GOODS_IMAGE_MAINApp">
cosimg = re.compile('<img width="\d+" height="\d+" src="(.+?)"')

# <a href="http://cosplayjav.pl/11295/%e3%81%b1%e3%82%8b%e3%83%97%e3%82%93%e3%81%a6-%e3%81%bf%e3%81%9a%e3%81%97%e3%81%83%ef%bc%86stocking/">
